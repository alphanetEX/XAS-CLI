...
$pass | sudo -S etckeeper commit -m "Powerline dependencies installed"
...
$pass | sudo -S etckeeper commit -m "OhMyZSH dependencies installed"
...
$pass | sudo -S etckeeper commit -m "Powerlevel9K dependencies installed"